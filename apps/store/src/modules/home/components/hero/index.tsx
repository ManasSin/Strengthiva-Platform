...
const Hero = () => {
  return (
    <div className="h-[75vh] w-full border-b border-hairline relative bg-gradient-to-b from-primary/5 to-white">
      <div className="absolute inset-0 z-10 flex flex-col justify-center items-center text-center small:p-32 gap-6">
        <span>
          ...
          <Heading level="h2" className="mt-3 text-xl small:text-2xl leading-snug text-forest font-medium">
