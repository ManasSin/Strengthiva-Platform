          ...
          <div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3">
            {productCategories && productCategories?.length > 0 && (
              <div className="flex flex-col gap-y-2">
                <span className="txt-small-plus text-brandneutral">
                  Categories
                </span>
                <ul
                ...
                >
                  {productCategories?.slice(0, 6).map((c) => {
                    ...
                    return (
                      <li
                        className="flex flex-col gap-2 text-grey-60 txt-small"
                        key={c.id}
                      >
                        <LocalizedClientLink
                          className={clx(
            ...
            {collections && collections.length > 0 && (
              <div className="flex flex-col gap-y-2">
                ...
                <ul
                  className={clx(
                    "grid grid-cols-1 gap-2 text-grey-60 txt-small",
                    {
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <ul className="grid grid-cols-1 gap-y-2 text-grey-60 txt-small">
                ...
                <li>
                  <LocalizedClientLink href="/account" className="hover:text-primary">
                    My Account
                  </LocalizedClientLink>
                </li>
              </ul>
