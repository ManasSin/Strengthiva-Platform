      ...
      <div className="mt-10 grid gap-5 md:grid-cols-2">
        {items.map((item) => (
          ...
          >
            ...
            <h3
              className={`font-headline text-xl font-bold ${item.lead ? "mt-4" : ""} ${
    ...
    <section className="border-y border-border bg-tertiary/30 py-16 md:py-20">
      <div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-[2fr_3fr] md:items-center">
        ...
        <div>
          ...
          <h2 className="mt-3 font-headline text-3xl font-bold text-foreground">
            Dr. Dheeraj
          </h2>
  ...
  return (
    <section className="border-t border-border bg-primary py-16 text-white md:py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="max-w-2xl">
          <h2 className="font-headline text-3xl font-bold">What we won&apos;t tell you</h2>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          {promises.map((promise) => (
            <div key={promise.title} className="rounded-2xl bg-white/10 p-6">
              <h3 className="font-headline text-lg font-semibold">{promise.title}</h3>
