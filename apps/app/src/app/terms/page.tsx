    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <h1 className="text-[clamp(1.875rem,4vw,2.5rem)]">Terms of Service</h1>
          ...
          <div className="space-y-8 text-sm leading-relaxed text-foreground">
            <section>
              <h2 className="text-subhead">Not medical advice</h2>
            ...
            <section>
              <h2 className="text-subhead">Your account</h2>
              <p className="mt-2 text-muted-foreground">
            ...
            <section>
              <h2 className="text-subhead">Assessment accuracy</h2>
              <p className="mt-2 text-muted-foreground">
            ...
            <section>
              <h2 className="text-subhead">Purchases</h2>
              <p className="mt-2 text-muted-foreground">
