    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <h1 className="font-headline text-3xl font-bold text-foreground">Terms of Service</h1>
          ...
          <div className="space-y-8 text-sm leading-relaxed text-foreground">
            <section>
              <h2 className="font-headline text-lg font-semibold">Not medical advice</h2>
            ...
            <section>
              <h2 className="font-headline text-lg font-semibold">Your account</h2>
              <p className="mt-2 text-muted-foreground">
            ...
            <section>
              <h2 className="font-headline text-lg font-semibold">Assessment accuracy</h2>
              <p className="mt-2 text-muted-foreground">
            ...
            <section>
              <h2 className="font-headline text-lg font-semibold">Purchases</h2>
              <p className="mt-2 text-muted-foreground">
