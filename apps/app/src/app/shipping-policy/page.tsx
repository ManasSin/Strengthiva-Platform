    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <h1 className="text-[clamp(1.875rem,4vw,2.5rem)]">Shipping Policy</h1>
          ...
          <div className="space-y-8 text-sm leading-relaxed text-foreground">
            <section>
              <h2 className="text-subhead">Processing time</h2>
            ...
            <section>
              <h2 className="text-subhead">Delivery</h2>
              <p className="mt-2 text-muted-foreground">
            ...
            <section>
              <h2 className="text-subhead">Order tracking</h2>
              <p className="mt-2 text-muted-foreground">
            ...
            <section>
              <h2 className="text-subhead">Questions</h2>
              <p className="mt-2 text-muted-foreground">
                Reach us at{" "}
