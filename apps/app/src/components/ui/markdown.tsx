    ...
    <div className={`space-y-3 text-sm leading-relaxed ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ children }) => <h4 className="font-display text-base font-medium">{children}</h4>,
          h2: ({ children }) => <h4 className="font-display text-base font-medium">{children}</h4>,
          h3: ({ children }) => <h4 className="font-display text-sm font-medium">{children}</h4>,
